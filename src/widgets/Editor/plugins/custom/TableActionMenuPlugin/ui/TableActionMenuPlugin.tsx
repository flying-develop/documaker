...
import type { TableCellActionMenuProps } from '../types';
    ...
    useEffect(() => {
        ...
        if (menuButtonDOM != null && tableCellNode != null) {
            ...
            if (tableCellNodeDOM != null) {
                ...
                const top = tableCellRect.top - anchorRect.top + 9;
                const left = tableCellRect.right - menuRect.width - 5 - anchorRect.left;
